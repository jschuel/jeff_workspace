...
for i in dates:
    if i == "11":
        ...
        df.to_root('~/data/phase2/combined_SKB_TPC_ntuples/June_11_HER_all_pressures.root', key='data')
    if i == "12":
        df = make_combined_dataframe(i, "LER")
        df.to_root('~/data/phase2/combined_SKB_TPC_ntuples/June_12_LER_all_pressures.root', key='data')
