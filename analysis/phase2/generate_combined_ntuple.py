...
#SKB_input = "/Users/vahsengrouplaptop/data/phase2/SKB_data/07-%s-2018_interpolated.root"%(day) #input file with SKB parameters
SKB_input = "/Users/vahsengrouplaptop/data/phase2/SKB_data/June_%s_SKB.root"%(day)
...
for module in module_id:
    tpc_input[module] = "/Users/vahsengrouplaptop/data/phase2/background_studies/6-%s_%s/most_updated/%s_all.root"%(day,ring,module)
output_f = '/Users/vahsengrouplaptop/data/phase2/combined_SKB_TPC_ntuples/June_%s_study.root'%(day) #output combined TPC + SKB analysis ntuple
