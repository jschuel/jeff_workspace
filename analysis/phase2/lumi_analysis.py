...
mg_LER, legend_LER, fit_params_LER = make_heuristic_plots(df_LER, module_ids, "LER")
mg_HER, legend_HER, fit_params_HER = make_heuristic_plots(df_HER, module_ids, "HER")

df = extract_variables_LUMI(df_LUMI_input, module_ids, 60)
...
for module in module_ids:
    c1.cd(n)
    grs[module] = make_decay_plot(df,module)
    n+=1
    grs[module].Draw("AP")
