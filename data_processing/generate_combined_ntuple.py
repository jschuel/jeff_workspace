...
SKB_input = "~/data/phase3/spring_2020/05-09-20/SKB+LUMI_archiver_with_flag.root"
...
SKB_input = "~/data/phase3/PVM/Dec_%s_%s_updated.root"%(day, ring) #input file with SKB parameters
if ring == "LUMI":
    module_id = ["tako", "palila", "elepaio", "iiwi", "nene", "humu"]
else:
...
output_f = '~/data/phase3/combined_SKB_TPC_ntuples/Dec_%s_%s_study_new.root'%(day, ring) #output combined TPC + SKB analysis ntuple
