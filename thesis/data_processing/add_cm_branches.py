...
class update_file:
    ...
    def load_file(self, input_file='/Users/vahsengrouplaptop/workspace/thesis_data/mc_with_reco_cm.root'):
    ...
    def add_branches(self, output_file='/Users/vahsengrouplaptop/workspace/thesis_data/mc_with_reco_cm.root'):
        boosted_data = self.apply_boost()
        boosted_data.to_root(output_file, key = 'lepton', mode = 'a')
