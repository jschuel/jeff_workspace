...
class merge_ntuples:
    ...
    def process_and_combine_merged_ntuples(self, infiledir = '~/data/thesis_data/raw_analysis_ntuples/', outfiledir = '~/data/thesis_data/combined_reco_ntuples/', num_events_per_file = 1000, keys = ['B', 'e', 'mu']):
