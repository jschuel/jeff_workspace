...
class lepton_analysis:
    ...
    def load_data(self, input_file = '~/data/thesis_data/mc_with_deltaT.root', key = 'truth_lepton'):
        data = rp.read_root(input_file, key=key)
        return data

    def get_data_with_cuts(self, input_file = '~/data/thesis_data/mc_with_deltaT.root', key = 'truth_lepton'):
        data = self.load_data()
...
class truth_B_analysis:
    ...
    def load_data(self, input_file = '~/data/thesis_data/mc_with_deltaT.root', key = 'truthB_lab'):
        data = rp.read_root(input_file, key=key)
        return data
...
class process_lepton_data(lepton_analysis): #only call to add deltaT branches to root file. Takes a while to run
    def __init__(self, input_data = '~/data/thesis_data/mc_with_reco.root', output_data = '~/data/thesis_data/mc_with_deltaT.root', key = 'truth_lepton'):
        super().__init__()
...
class process_B_data(truth_B_analysis): #only call to add deltaT branches to root file. Takes a while to run
    def __init__(self, input_data = '~/data/thesis_data/mc_with_reco.root', output_data = '~/data/thesis_data/mc_with_deltaT.root', key = 'truthB_lab'):
        super().__init__()
