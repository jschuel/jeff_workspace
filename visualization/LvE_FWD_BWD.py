...
def get_parameters(module_id):
    ...
    #ch.Add("~/data/phase2/background_studies/7-12_lumi/%s_all.root"%(module_id))
    ch.Add("~/data/phase3/spring_2020/05-09-20/tpc_root_files/%s_all_new.root"%(module_id))
    #neutrons.Add("~/data/phase2/background_studies/7-12_lumi/%s_all.root"%(module_id))
    neutrons.Add("~/data/phase3/spring_2020/05-09-20/tpc_root_files/%s_all_new.root"%(module_id))
 ...
 && hitside_col_max == 0 && hitside_row_min == 0 && hitside_row_max == 0") 
    ...
    #neutrons.Add("~/data/phase3/phase3_background_root/tpc_tools/Dec_7_%s_phase3.root"%(module_id))
